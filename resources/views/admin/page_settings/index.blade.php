    ...
    <form action="{{ route('admin.page_settings.update') }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div id="content-profile" class="tab-content hidden">
            ...
            <div class="max-w-4xl mx-auto mb-16">
                ...
                <div class="relative pt-4 pl-4">
                    <div class="relative">
                        <div class="absolute -bottom-5 -left-5 w-full h-full bg-[#2299c4] rounded-[30px]"></div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="relative pt-4 pr-4">
                     <div class="relative">
                        <div class="absolute -bottom-4 -right-4 w-full h-full bg-[#a3dcee] rounded-[40px]"></div>
        ...
        <div id="content-visi-misi" class="tab-content hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                {{-- VISI CARD --}}
                <div class="bg-white rounded-[30px] border-[3px] border-red-600 p-8 shadow-[0_10px_30px_rgba(34,153,196,0.18)] flex flex-col">
            ...
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="dashboard_hero_title" value="{{ $settings['dashboard_hero_title'] ?? '' }}" class="w-full bg-white border-gray-300 rounded-lg px-4 py-2" placeholder="We Solve Your Problem">
                    </div>
                     <div>
