    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required class="w-full border border-gray-200 rounded-lg py-3 px-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow duration-200" placeholder="Masukkan judul proyek...">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="client" value="{{ old('client') }}" class="w-full border border-gray-200 rounded-lg py-3 px-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow duration-200" placeholder="Nama Klien / Instansi...">
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year', date('Y')) }}" class="w-full border border-gray-200 rounded-lg py-3 px-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow duration-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="tag" value="{{ old('tag') }}" class="w-full border border-gray-200 rounded-lg py-3 px-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow duration-200" placeholder="Contoh: Fabrikasi">
            ...
            <div>
                ...
                <textarea name="description" rows="6" required class="w-full border border-gray-200 rounded-lg py-3 px-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow duration-200" placeholder="Tulis deskripsi detail proyek...">{{ old('description') }}</textarea>
            ...
            <div>
                ...
                <p class="text-gray-500 text-xs mt-1">Pilih beberapa file sekaligus untuk dijadikan galeri pendukung proyek.</p>
