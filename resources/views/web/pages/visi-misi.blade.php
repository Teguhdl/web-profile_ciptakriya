            ...
            <x-cke.card padded elevation="raised">
                ...
                <div class="cke-about__p">
                    ...
                    <ul style="list-style: none; padding: 0; display: flex; flex-direction: column; gap: 1rem;">
                        ...
                        <li style="display: flex; gap: 1rem;"><span style="color: var(--color-primary);">@include('web.partials.icon', ['name' => 'check', 'size' => 20])</span> <span>Membangun <strong>sumber daya manusia unggul</strong> untuk berprestasi, berkreasi, dan tumbuh bersama berlandaskan nilai-nilai budaya PT Cipta Kriya Engineering.</span></li>
                    </ul>
                    @endif
                </div>
            </x-cke.card>
