...
<header id="main-header" class="cke-hd cke-hd--solid transition-all duration-300">
    <div class="cke-hd__inner">
        ...
        <a class="cke-hd__brand" href="{{ url('/') }}">
            <span class="cke-hd__logochip">
                <img id="main-logo" src="{{ asset('assets/web/logo/cke-logomark.png') }}" alt="Cipta Kriya Engineering" style="width:100%;height:100%;object-fit:contain;padding:4px;">
            </span>
            <span class="cke-hd__wordmark">
