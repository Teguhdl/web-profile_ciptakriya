...
(() => {
  ...
  document.querySelectorAll('nav .relative').forEach(parent => {
    ...
    // Hover logic via JS for safety (can also be pure CSS group-hover)
  ...
  const hasFeedback = document.querySelector('.cke-contact__success') || document.querySelector('.cke-danger-bg');
  if (hasFeedback) {
