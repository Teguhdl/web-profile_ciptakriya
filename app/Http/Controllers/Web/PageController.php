...
class PageController extends Controller
{
    ...
    {
        $meta = [
            'title' => $page->meta_title ?? 'PT. Cipta Kriya Engineering - We Solve Your Problem',
            'description' => $page->meta_description ?? 'PT. Cipta Kriya Engineering adalah perusahaan engineering multi-disiplin yang melayani konstruksi mekanikal, elektrikal, fabrikasi, dan batching plant di Indonesia.',
        ...
        $data['contact_phone'] = $data['contact_phone'] ?? '+62 812-3456-7890';
        $data['contact_email'] = $data['contact_email'] ?? 'info@ciptakriyaengineering.com';
        $data['contact_email_2'] = $data['contact_email_2'] ?? null; // Optional
        $data['contact_address'] = $data['contact_address'] ?? 'Kabupaten Subang, Jawa Barat, Indonesia';
        $data['contact_hours_mon_fri'] = $data['contact_hours_mon_fri'] ?? '08:00 – 17:00 WIB';
        $data['contact_hours_sat'] = $data['contact_hours_sat'] ?? '08:00 – 14:00 WIB';
